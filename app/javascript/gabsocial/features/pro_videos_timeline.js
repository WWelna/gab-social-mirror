...
function ProVideosTimeline() {
  return (
    <>
      <ResponsiveClassesComponent classNamesXS={[_s.d, _s.pt10].join(' ')}>
        <ExploreTimelinePills />
      </ResponsiveClassesComponent>
      <GroupSortBlock timelineId='pro:videos' />
      <StatusList
        timelineId='pro:videos'
        endpoint='/api/v1/timelines/pro?media_type=videos'
        queue
        showAds
...
export default ProVideosTimeline
