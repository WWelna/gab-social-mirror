      ...
      <div className={[_s.d].join(' ')}>
        <Block>
          <div className={[_s.d, _s.px15, _s.py15].join(' ')}>
            ...
            <Text tagName='p' className={_s.mt15} size='medium'>Gab AI Inc (“We” or “Gab”) hereby allow you to access certain premium features or content in exchange for a one-time or recurring fee, as applicable to the relevant features or content, such as our “GabPro” enhanced social media offering, our Dissenter Shop, or On Gab web teleconferencing service (each a “Paid Service” and collectively the "Paid Services"). Your transactions and any other use of the Paid Services are subject to these Gab Paid Service Terms of Sale ("Terms”).</Text>
