...
class StatusVisibilityDropdown extends React.PureComponent {
  handleChange = privacy => {
    this.props.onVisibility(privacy)
    this.props.onClosePopover()
  }
  render() {
    const { intl, privacy, isXS } = this.props
    ...
    return (
      <PopoverLayout width={300} isXS={isXS} onClose={this.onClosePopover}>
...
export default injectIntl(
  connect(null, mapDispatchToProps)(StatusVisibilityDropdown)
)
