...
class UserSuggestionsPanel extends ImmutablePureComponent {
  ...
  updateOnProps = ['suggestions', 'isLazy', 'shouldLoad']
  ...
  render() {
    const { intl, isLoading, suggestions, suggestionType } = this.props
...
export default injectIntl(
  connect(mapStateToProps, mapDispatchToProps)(UserSuggestionsPanel)
)
