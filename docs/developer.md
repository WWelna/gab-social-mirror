...
Developers wanting to work on [Gab Social](https://code.gab.com/gab/gab-open-source) source code and make changes to the system must configure a host for use with Gab Social's development environment.
...
[Gab Social](https://code.gab.com/gab/gab-open-source) development has been tested on [Ubuntu 18.04LTS](https://www.ubuntu.com/download/desktop). As we continue to migrate further away from Gab Social's code, at least MacOS will be supported as a choice.
...
The following software components and libraries are required by [Gab Social](https://code.gab.com/gab/gab-open-source).
...
Node.js is required for running the [Gab Social](https://code.gab.com/gab/gab-open-source) Streaming API server and for other system management tasks related to the Gab Platform.
...
[Ruby](https://www.ruby-lang.org/en/) version which [Gab Social](https://code.gab.com/gab/gab-open-source) uses. That version will also need to be enabled.
...
Now that [Ruby](https://www.ruby-lang.org/en/) is enabled, we will clone the [Git Social git repository](https://code.gab.com/gab/gab-open-source) and install the [Ruby](https://www.ruby-lang.org/en/) and [node.js](https://nodejs.org/en/) dependancies.
